...
import com.thunderclouddev.deeplink.data.SharedPrefsFileSystem
...
class SharedPrefsDeepLinkDatabase(context: Context) : DeepLinkDatabase {
    private val fileSystem = SharedPrefsFileSystem(context, Constants.Companion.DEEP_LINK_HISTORY_KEY)
