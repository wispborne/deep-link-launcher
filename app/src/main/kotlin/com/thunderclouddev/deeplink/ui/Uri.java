...
import com.thunderclouddev.deeplink.data.UriCodec;
...
public abstract class Uri implements Comparable<Uri> {
    ...
    */
        ...
        do {
            ...
            if (separator - start == encodedKey.length()
                ...
                if (separator == end) {
                    ...
                    return UriCodec.Companion.decode(encodedValue, true, StandardCharsets.UTF_8, false);
                }
            }
    ...
    public static String decode(String s) {
        ...
        return UriCodec.Companion.decode(s, false, StandardCharsets.UTF_8, false);
    }
